...
**Created**: [DATE]  
**Status**: Draft  
**Delivery Level**: [Lite | Micro | Standard | Critical] <!-- REQUIRED. See
  docs/sdlc/critical-delivery.md for the level definitions and when a feature MUST be
  Critical. Lite features use the lightweight branch lane and skip this template entirely;
