...
This file defines mandatory frontend performance rules for FMS.

FMS screens may include large tables, financial reports, dashboards, filters, and forms. Frontend performance must be considered during implementation, not after users complain.
...
- `docs/frontend/frontend-tables.md`
...
- `docs/frontend/frontend-forms.md`
